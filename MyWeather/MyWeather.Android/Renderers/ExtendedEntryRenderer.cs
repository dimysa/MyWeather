...
{
    public class ExtendedEntryRenderer : Xamarin.Forms.Platform.Android.AppCompat.ViewRenderer<ExtendedEntry, TextInputLayout>, ITextWatcher, TextView.IOnEditorActionListener
    {
        ...
        private void ControlOnFocusChange(object sender, FocusChangeEventArgs args)
        {
            if (args.HasFocus)
            {
                ...
                //},
                //    100);
                //Element.PlaceholderColor = ColorHelper.GetStyleColor("GreenishTeal");
            }
            else
            {
                //if (Element.Text == "")
                //Element.PlaceholderColor = ColorHelper.GetStyleColor("WhiteTwo25");
            }
        ...
        {
            //Control.EditText.SetHintTextColor(ColorHelper.GetStyleColor("GreenishTeal").ToAndroid());
        }
        ...
        private void SetHorizontalTextAlignment()
        {
            switch (Element.HorizontalTextAlignment)
            {
                case Xamarin.Forms.TextAlignment.Center:
                    Control.EditText.Gravity = GravityFlags.CenterHorizontal;
                    break;
